...
- Slack window: last 24 hours, channels constrained to allowlist/prefix list.
  - Use one broad query: `after:{slack_after_date}`.
  - Do not issue one call per channel.
  - Returning broader Slack rows is acceptable; downstream code will filter by configured allowlist/prefix.
